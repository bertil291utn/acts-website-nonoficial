    ...
    <>
      ...
      <section id="program" className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
        <div className="prose prose-slate max-w-none">
          <p className="not-prose font-serif text-xl font-semibold text-acts-navy">
            <EcuadorWordLinks text={t("school.pAndes")} />
          </p>
          <p className="text-slate-700">
            <EcuadorWordLinks text={t("school.pHost")} />
          </p>
          <h3 className="font-serif text-xl text-acts-navy">
          ...
          <div className="not-prose my-6 grid gap-3 sm:grid-cols-2">
            {(
              ...
              >
                ...
                <p className="mt-1 text-sm font-medium text-acts-navy">
          ...
          <p className="font-medium text-acts-navy">
          ...
          <div className="not-prose mt-10 space-y-12 border-t border-slate-200 pt-10">
            <div>
              <h3 className="font-serif text-xl font-semibold text-acts-navy">
                {t("applyLatamTitle")}
              </h3>
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <a
                  ...
                  className="inline-flex rounded-md bg-acts-navy px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-acts-navy/90"
                  target="_blank"
                ...
                <a
                  ...
                  className="inline-flex rounded-md border border-slate-300 bg-white px-5 py-2.5 text-sm font-semibold text-acts-navy transition hover:border-acts-navy"
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <div>
              ...
              <a
                ...
                className="mt-4 inline-flex rounded-md bg-acts-navy px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-acts-navy/90"
                target="_blank"
                rel="noopener noreferrer"
              >
                {t("applyHereCta")}
        ...
        <div className="relative mt-12 aspect-[16/9] overflow-hidden rounded-2xl bg-slate-200 lg:aspect-[2/1]">
          <Image
      ...
      <section className="border-y border-slate-200 bg-white py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="rounded-2xl bg-acts-navy px-6 py-12 text-white sm:px-12">
            <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              ...
              <Link
                href="/info#contact"
                className="inline-flex shrink-0 rounded-md bg-white px-8 py-3 text-sm font-semibold text-acts-navy"
              >
                {t("bandCta")}
              </Link>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        ...
        <ul className="mt-6 grid gap-4 sm:grid-cols-2">
          {(messages.EcuadorPage.checks as string[]).map((item) => (
            ...
            >
              <span className="text-acts-navy">✓</span>
              <span>
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          <Link
            href="/info#contact"
            className="inline-flex rounded-md bg-acts-navy px-6 py-3 text-sm font-semibold text-white"
          >
            {t("contactCta")}
          </Link>
          <Link
            href="/schools"
            className="inline-flex rounded-md border border-slate-300 px-6 py-3 text-sm font-semibold text-acts-navy"
          >
            {t("schoolsCta")}
          </Link>
        </div>
